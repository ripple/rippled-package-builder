...
const DOCKER_RUN = `sudo docker run -e "AWS_ACCESS_KEY_ID=${process.env.AWS_ACCESS_KEY_ID}" -e "AWS_SECRET_ACCESS_KEY=${process.env.AWS_SECRET_ACCESS_KEY}" -e "GPG_PASSPHRASE=${process.env.GPG_PASSPHRASE}"` 
